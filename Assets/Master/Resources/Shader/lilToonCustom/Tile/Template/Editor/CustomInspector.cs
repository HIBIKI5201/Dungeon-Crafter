...
namespace lilToon
{
    public class TemplateFullInspector : lilToonInspector
    {
        ...
        MaterialProperty _TileSize;

        private static bool isShowCustomProperties;
        private const string shaderName = "DCTile";
        ...
        protected override void LoadCustomProperties(MaterialProperty[] props, Material material)
        {
            ...
            _TileSize = FindProperty("_TileSize", props);
        }
        ...
        protected override void DrawCustomProperties(Material material)
        {
            ...
            if(isShowCustomProperties)
            {
                ...
                m_MaterialEditor.ShaderProperty(_TileSize, GetLoc("_TileSize"));
